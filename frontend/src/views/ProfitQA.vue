  ...
  <div class="profit-qa">
    ...
    <div class="header">
      <div class="header-left">
        ...
        <div class="title-group">
          <h1>毛利抽成查询</h1>
          <span class="subtitle">查询分成比例与结算规则</span>
        </div>
      </div>
    ...
    <div class="messages" ref="messagesContainer">
      <div v-if="messages.length === 0" class="welcome">
        <div class="welcome-icon">
          <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
            ...
            <path d="M36 16v40M26 26l10-10 10 10M26 46l10 10 10-10" stroke="#52c41a" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
        <h2>欢迎使用毛利抽成查询</h2>
      ...
      <div v-if="clarificationOptions.length > 0" class="message-wrapper assistant">
        <div class="avatar"><div class="ai-avatar ai-green"><svg width="20" height="20" viewBox="0 0 20 20" fill="white"><path d="M10 4v12M5 9l5-5 5 5M5 11l5 5 5-5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div></div>
...
import { queryProfit, checkHealth, getSession } from '../services/api.js'
...
const suggestions = ['本月毛利分成比例是多少？', '渠道 A 的抽成规则是什么？', '结算周期是什么时候？']
...
<style scoped>
.profit-qa { max-width: 1000px; margin: 0 auto; padding: 0; min-height: 100vh; display: flex; flex-direction: column; }
...
.suggestion-btn:hover { border-color: #52c41a; color: #52c41a; transform: translateY(-2px); }
...
.ai-avatar { background: linear-gradient(135deg, #52c41a 0%, #389e0d 100%); box-shadow: 0 4px 12px rgba(82, 196, 26, 0.3); }
