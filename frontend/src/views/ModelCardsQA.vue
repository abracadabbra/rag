<template>
  <div class="model-cards-qa">
    <SessionSidebar :isOpen="sidebarOpen" :currentSessionId="sessionId" sceneType="model_card" @close="sidebarOpen = false" @select-session="handleSelectSession" @session-created="handleSessionCreated" ref="sidebar" />
    <header class="header">
      <div class="header-left">
        ...
        <div class="title-group"><h1>模型卡片</h1><span class="subtitle">查询模型部署与特征</span></div>
      </div>
...
import { queryModelCards } from '../services/api.js'
...
const suggestions = ['最新部署了哪些模型？', 'A 模型的离线指标如何？', 'B 模型适合什么场景？']
...
<style scoped>
.model-cards-qa { max-width: 960px; margin: 0 auto; padding: 0; min-height: 100vh; display: flex; flex-direction: column; position: relative; z-index: 1; }
