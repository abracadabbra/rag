    ...
    <div class="header">
      <div class="header-left">
        ...
        <div class="title-group">
          <h1>仿真解读</h1>
          <span class="subtitle">解读仿真结果、分析模型表现</span>
        </div>
      </div>
      ...
      <div v-if="messages.length === 0" class="welcome">
        <div class="welcome-icon">
          <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
            ...
            <path d="M20 44V24l12-9 12 9v20" stroke="#fa8c16" stroke-width="2.5" fill="none" stroke-linejoin="round"/>
            <circle cx="32" cy="32" r="4" stroke="#fa8c16" stroke-width="2.5" fill="none"/>
          </svg>
        </div>
        <h2>欢迎使用仿真解读系统</h2>
        <p>查询仿真结果、模型表现、数据分析等</p>
        ...
        <div class="avatar">
          ...
          <div v-else class="ai-avatar ai-orange">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="white">
              ...
              <circle cx="10" cy="12" r="1.5" stroke="white" stroke-width="1" fill="none"/>
            </svg>
          </div>
        </div>
...
import { querySimulation, checkHealth } from '../services/api.js'
...
.suggestion-btn:hover { border-color: #fa8c16; color: #fa8c16; }
...
.ai-avatar { background: linear-gradient(135deg, #fa8c16 0%, #d46b08 100%); }
